...
void print_float(ofstream &output, vector<vector<float>> & in_matrix_cpp){
...
void multiply_float_avx(ofstream &output, vector<vector<float>> & in_matrix_cpp, vector<vector<float>> & in_matrix_cpp_transpose, vector<vector<float>> & out_matrix, bool print_transpose = false, bool print_output = false){
...
void multiply_cpp(ofstream &output, vector<vector<float>> & in_matrix_cpp, vector<vector<float>> & out_matrix_cpp, bool print_output = false ){
    ...
    if(print_output){
        print_float(output,out_matrix_cpp);
    }
}
...
int main(int argc, char* argv[]){
    ...
    if( (numtype == "float") && (numsize == 4) ){
        ...
        output << endl;
        print_float(output, in_matrix_cpp);

        cout << "transpose matrix: " << endl;
        cout << endl;
        output << "transpose matrix: " << endl;
        output << endl;
        print_float(output, in_matrix_cpp_transpose);
        ...
        output << endl;
        multiply_float_avx(output, in_matrix_cpp,in_matrix_cpp_transpose,out_matrix_avx,false,true);
    }
    else{
